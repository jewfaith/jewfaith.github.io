...
const KETUVIM_TOTAL_WEIGHT = KETUVIM_BOOKS.reduce((sum, b) => sum + b.weight, 0);
...
function getFestivalSpan(events, now, twentyFourHoursMs, cat) {
    const evts = events
...
function findActiveFestival(events, now, twentyFourHoursMs, cats) {
