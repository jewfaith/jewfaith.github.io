...
export function updateShaahZmanitCardPosition() {
    ...
    try {
        const restStatus = checkSacredRestStatus(now, state.unifiedEvents, state.currentHDate, state.currentSunsetTime);
    ...
    if (!isFestivalActiveOrRecent) {
        ...
        // Durante o Shabat/Yom Tov ou até 2h pós-Havdalá, a Data Hebraica/Festa permanece no topo
