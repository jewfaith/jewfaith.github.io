...
function renderProductCard(product) {
    ...
    if (isAvailable) {
        actionButtonHtml = `
            <button type="button" 
               class="premium-btn-action premium-btn-buy premium-open-product-modal-btn"
        ...
        actionButtonHtml = `
            <span class="premium-btn-action premium-btn-soon" 
                  style="width: 100%;"
                  aria-disabled="true" 
        ...
        actionButtonHtml = `
            <span class="premium-btn-action premium-btn-disabled" style="width: 100%;" aria-disabled="true">
    ...
    return `
        <div class="premium-product-card glass-panel" data-category="${product.category}">
            ...
            <div class="premium-product-footer" style="justify-content: flex-end;">
                <div class="premium-product-action-box" style="width: 100%;">
                    ${actionButtonHtml}
                </div>
            </div>
        </div>
...
function renderCategoriesOverview() {
    ...
    return `
        <div class="festival-section-header" style="margin-top: 24px;">
...
export function renderPremiumView(force = false) {
    ...
    container.innerHTML = `
        <div class="premium-view-wrapper">
            ...
            <div class="festival-section-header" style="margin-top: 20px;">
                <div class="festival-section-title-wrap">
                    <h3 class="festival-section-title">Conteúdos Premium</h3>
                </div>
            </div>
