...
export const FESTIVAL_DESCRIPTIONS = {
    'Yom Shabbat': {
        info: 'É um mandamento da Torah que estabelece o sétimo dia como um tempo separado para descanso, santidade e proximidade com Deus, constituindo também um sinal especial entre Deus e Yisrael.',
    ...
    'Pessach Sheni': {
        info: 'É um mandamento da Torah que estabelece uma segunda oportunidade para cumprir o Pessach quando alguém esteve impedido de participar na celebração original.',
    ...
    'Yom Pessach': {
        info: 'É uma festa da Torah que recorda a libertação de Yisrael da escravidão no Egito e está ligada ao sacrifício de Pessach e à memória da saída do Egito.',
    ...
    'Chag Matzot': {
        info: 'É uma festa da Torah dedicada à memória da saída de Yisrael do Egito, marcada pela remoção do chametz e pelo consumo de matzah durante sete dias.',
    ...
    'Yom Shavuot': {
        info: 'É uma festa da Torah que encerra a contagem das sete semanas e está ligada às primícias, à colheita e à alegria perante Deus. A associação com a entrega da Torah no Sinai pertence à tradição posterior.',
    ...
    'Yom Teruah': {
        info: 'É uma festa da Torah marcada por descanso, convocação santa e teruah no primeiro dia do sétimo mês. A designação posterior de Rosh Hashanah pertence à tradição desenvolvida posteriormente.',
    ...
    'Yom Kippur': {
        info: 'É uma festa da Torah dedicada à expiação perante Deus, marcada por descanso completo, aflição da alma e uma observância especial de santidade.',
    ...
    'Chag Sukkot': {
        info: 'É uma festa da Torah marcada pela alegria perante Deus e pela memória da proteção de Yisrael durante a passagem pelo deserto, sendo também conhecida pela habitação em sukkot durante sete dias.',
    ...
    'Shemini Atzeret': {
        info: 'É uma festa da Torah que ocorre no oitavo dia após Sukkot e constitui uma convocação santa própria, distinta dos sete dias anteriores da festa.',
    ...
    'Simchat Torah': {
        info: 'É uma tradição rabínica dedicada à celebração da Torah através da conclusão do ciclo de leitura e do seu reinício imediato, expressando a continuidade do estudo e da transmissão da Torah.',
    ...
    'Sefirat Omer': {
        info: 'É um mandamento da Torah que consiste na contagem de sete semanas entre Pessach e Shavuot, estabelecendo um período de preparação e ligação entre as duas celebrações.',
    ...
    'Yom Purim': {
        info: 'É uma festa rabínica que recorda a salvação de Yisrael perante a ameaça de Haman durante o período persa e celebra a transformação de uma situação de destruição anunciada numa ocasião de alegria.',
    ...
    'Rosh Chodesh': {
        info: 'É um mandamento da Torah relacionado com o início de cada novo mês e com a organização do calendário de Yisrael, possuindo também importância própria dentro do serviço e das celebrações de cada mês.',
    ...
    'Ta\'anit Esther': {
        info: 'É um jejum rabínico realizado antes de Purim e associado ao jejum realizado por Esther e pelo povo de Yisrael antes da sua intervenção perante o rei.',
    ...
    'Tzom Tammuz': {
        info: 'É um jejum rabínico que inicia o período tradicional de luto que conduz a Tisha B\'Av e recorda acontecimentos associados à ruptura e às calamidades que atingiram Yisrael.',
    ...
    'Tisha B\'Av': {
        info: 'É um jejum rabínico dedicado principalmente ao luto pela destruição dos Templos de Jerusalém e pela memória de outras calamidades sofridas por Yisrael ao longo da sua história.',
        torah: 'Tisha B\'Av não é estabelecido diretamente pela Torah. No entanto, Devarim 30:1-3 descreve a possibilidade de retorno a Deus depois de uma calamidade, enquanto Vayikra 26:40-45 apresenta a confissão e o arrependimento como caminhos para a restauração da aliança.',
        ...
        ketuvim: 'O Livro de Lamentações é central para o espírito de Tisha B\'Av. Eichah 1:1-5 descreve a destruição e a solidão de Jerusalém, enquanto Eichah 3:21-24 introduz esperança na misericórdia de Deus mesmo no meio da dor.',
        ...
        sod: 'Na tradição do Sod, Tisha B\'Av representa uma ruptura profunda entre Yisrael, Jerusalém e a presença divina. O Zohar II, 152a-153b utiliza a linguagem da destruição e da restauração para mostrar que o luto também pode conduzir ao desejo de reconstrução.'
    },

    'Tzom Gedaliah': {
        info: 'É um jejum rabínico que recorda a morte de Gedaliah ben Achikam após a destruição do Primeiro Templo e a consequente instabilidade e dispersão entre os sobreviventes de Yisrael.',
